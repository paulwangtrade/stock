...
func (a *App) GetAllStocks(page int, pageSize int, name string, industry string, concept string, plateCode string, technicalIndicators models.TechnicalIndicators) *models.AllStocksResp {
	return data.NewStockDataApi().GetAllStocks(page, pageSize, name, industry, concept, plateCode, technicalIndicators)
}

func (a *App) GetHotConceptPlates(limit int) []map[string]any {
	return data.NewStockDataApi().GetHotConceptPlates(limit)
}

func (a *App) GetHotIndustryPlates(limit int) []map[string]any {
	return data.NewStockDataApi().GetHotIndustryPlates(limit)
}
