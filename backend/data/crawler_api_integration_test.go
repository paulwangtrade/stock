...
func TestGetHtml(t *testing.T) {
	if testing.Short() {
		t.Skip("skip crawler integration test")
	}
	crawlerAPI := CrawlerApi{}
	crawlerBaseInfo := CrawlerBaseInfo{
		Name:        "TestCrawler",
...
func TestHk(t *testing.T) {
	...
	if testing.Short() {
		t.Skip("skip hk crawler integration test")
	}
	...
	crawlerAPI = crawlerAPI.NewCrawler(
		ctx,
		crawlerBaseInfo,
	)
	...
	for _, hk := range *hks {
		...
		htmlContent, ok := crawlerAPI.GetHtml(
			url,
			"#stock_cname",
			true,
		)
		...
		name := document.Find("#stock_cname").Text()
...
func TestUpdateUSName(t *testing.T) {
	if testing.Short() {
		t.Skip("skip crawler integration test: requires browser and external website")
	}
	db.Init("../../data/stock.db")
...
func TestUS(t *testing.T) {
	if testing.Short() {
		t.Skip("skip stock import integration test")
	}
	db.Init("../../data/stock.db")
...
func TestUSSINA(t *testing.T) {	
	if testing.Short() {
		t.Skip("skip sina crawler integration test")
	}
...
func TestSina(t *testing.T) {
	if testing.Short() {
		t.Skip("skip sina stock crawler test")
	}
	db.Init("../../data/stock.db")
...
func TestDC(t *testing.T) {
	if testing.Short() {
		t.Skip("skip eastmoney crawler test")
	}
