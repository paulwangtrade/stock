...
// BypassSponsorVip 本地二次开发：为 true 时跳过赞助码校验，视为最高 VIP 且始终有效。
const BypassSponsorVip = true

const bypassSponsorVipLevel = 9

// BypassSponsorInfo 供桌面端 GetSponsorInfo 返回，与前端现有字段格式一致。
func BypassSponsorInfo() map[string]any {
...
func EffectiveSponsorVipLevel() (level int, active bool) {
	if BypassSponsorVip {
		return bypassSponsorVipLevel, true
	}
